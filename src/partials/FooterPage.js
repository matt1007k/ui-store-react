		...
		<footer className="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
			...
			<div className="t-center p-l-15 p-r-15">
				...
				<div className="t-center s-text8 p-t-20">
					Copyright © {anio} All rights reserved. | This template is made with <i className="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
				</div>
			</div>
		</footer>	  
	</div>
